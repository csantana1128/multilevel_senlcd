...
#define RUCI_GET_ZWAVE_RSSI_EVENT               RUCI_NUM_GET_ZWAVE_RSSI_EVENT, ruci_elmt_type_get_zwave_rssi_event, ruci_elmt_num_get_zwave4_rssi_event
...
/* User should provide msg buffer is greater than sizeof(ruci_para_get_rssi_event_t) */
#define SET_RUCI_PARA_GET_ZWAVE_RSSI_EVENT(msg, r3_rssi_in, r2_rssi_in, r1_rssi_in, lr_rssi_in, lr_2_rssi_in, r3_2_rssi_in, r3_3_rssi_in)        \
        do{                                                                                                            \
        ((ruci_para_get_rssi_event_t *)msg)->ruci_header.u8                 = RUCI_PCI_EVENT_HEADER;                  \
        ((ruci_para_get_rssi_event_t *)msg)->sub_header                     = RUCI_CODE_GET_ZWAVE_RSSI_EVENT;         \
        ((ruci_para_get_rssi_event_t *)msg)->length                         = RUCI_PARA_LEN_GET_ZWAVE_RSSI_EVENT;     \
        ((ruci_para_get_rssi_event_t *)msg)->r3_rssi                        = r3_rssi_in;                             \
        ((ruci_para_get_rssi_event_t *)msg)->r2_rssi                        = r2_rssi_in;                             \
        ((ruci_para_get_rssi_event_t *)msg)->r1_rssi                        = r1_rssi_in;                             \
        ((ruci_para_get_rssi_event_t *)msg)->lr_rssi                        = lr_rssi_in;                             \
        ((ruci_para_get_rssi_event_t *)msg)->lr_2_rssi                      = lr_2_rssi_in;                           \
        ((ruci_para_get_rssi_event_t *)msg)->r3_2_rssi                      = r3_2_rssi_in;                           \
        ((ruci_para_get_rssi_event_t *)msg)->r3_3_rssi                      = r3_3_rssi_in;                           \
        }while(0)
