...
/* Chip version */
#define RF_MCU_CHIP_VER_SHUTTLE             (0x00)
#define RF_MCU_CHIP_VER_A                   (0x01)
#define RF_MCU_CHIP_VER_B                   (0x02)
#define RF_MCU_CHIP_VER_C                   (0x03)
...
#define RF_MCU_CHIP_VER                     (RF_MCU_CHIP_VER_SHUTTLE)
#else
#define RF_MCU_CHIP_VER                     (RF_MCU_CHIP_VER_B)
#endif
#endif
...
#define RF_MCU_FW_PRELOAD_SUPPORTED         (0x01)
