...
/**
 * @brief Defines the different power types that can be requested.
 * 
...
/**
 * @brief Defines the power modes the underlying platform can enter or leave.
 * 
 ...
 * @param[in] from The power mode from which the platform is coming.
 * @param[in] to The power mode to which the platform is going.
 */
