...
typedef enum
{
  ZPAL_LIBRARY_TYPE_CONTROLLER   = 0,     /**< Controller library*/
  ZPAL_LIBRARY_TYPE_END_DEVICE   = 1,     /**< End device library*/
  ZPAL_LIBRARY_TYPE_UNDEFINED    = 0xFF,  /**< Undefined*/
} zpal_library_type_t;
...
/**
 * @brief Get the node's library type.
 * @return library type.
 */
...
/**
 * @brief Set the node's library type
 *  This function should be called at the startup code.
 *  It can be used if PAL code need to be initiated differently depending on the library type
 *
 * @param[in] library_type The library type.
 *
 * @return Returns ZPAL_STATUS_OK on success, otherwise ZPAL_STATUS_FAIL.
 *
 */
