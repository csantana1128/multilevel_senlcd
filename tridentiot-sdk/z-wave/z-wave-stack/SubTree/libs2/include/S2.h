 ...
 * The values must stay aligned with TRANSMIT_COMPLETE_CODES
 * defined elsewhere in z-wave-stack/ZWave/API/ZW_transport_api.h
 */
typedef enum {
  /**
   * Frame was sent to node, we the node should have been able to decrypt the frame
   * but we don't know for sure.
   * This must stay aligned with the TRANSMIT_COMPLETE_OK value defined in z-wave-stack.
   */
  S2_TRANSMIT_COMPLETE_OK = 0x00,

  /**
   * Frame was not sent due to a MAC layer failure,
   * This must stay aligned with the TRANSMIT_COMPLETE_NO_ACK value defined in z-wave-stack.
   */
  S2_TRANSMIT_COMPLETE_NO_ACK = 0x01,

  /**
   * Frame was not sent because some other failure, i.e the node does not support S2.
   * This must stay aligned with the TRANSMIT_COMPLETE_FAIL value defined in z-wave-stack.
   */
   ...
   * This must stay aligned with the TRANSMIT_COMPLETE_VERIFIED value defined in z-wave-stack.
   */
  S2_TRANSMIT_COMPLETE_VERIFIED = 0x05,
