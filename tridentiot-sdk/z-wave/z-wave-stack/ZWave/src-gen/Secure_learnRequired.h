...
extern void secure_learnIface_send_commands_supported(const sc_integer node, const sc_integer txOptions);
extern void secure_learnIface_update_callback();

extern void secure_learnIface_state_start_timeout();

extern void secure_learnIfaceL_send_scheme_report(const sc_integer node, const sc_integer txOptions, const sc_integer secure);
...
*/
extern void secure_learn_setTimer(const sc_eventid evid, const sc_integer time_ms, const sc_boolean periodic);
...
/*! 
	...
	\param evid An unique identifier of the event.
*/
extern void secure_learn_unsetTimer(const sc_eventid evid);
