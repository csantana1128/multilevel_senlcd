...
typedef enum {
	...
	secure_learn_main_region_LearnMode_r1_EarlyStart ,
...
typedef struct {
  uint8_t dummy; /* Keil doesn't allow empty structs */
} Secure_learnIfaceL;
...
typedef struct {
	sc_boolean secure_learn_main_region_LearnMode_r1_Start_time_event_0_raised;
	sc_boolean secure_learn_main_region_LearnMode_r1_Scheme_report_time_event_0_raised;
	sc_boolean secure_learn_main_region_LearnMode_r1_NewKey_time_event_0_raised;
	sc_boolean secure_learn_main_region_InclusionMode_r1_SchemeRequest_time_event_0_raised;
	sc_boolean secure_learn_main_region_InclusionMode_r1_SendKey_time_event_0_raised;
	sc_boolean secure_learn_main_region_InclusionMode_r1_SendInterit_time_event_0_raised;
	sc_boolean secure_learn_main_region_InclusionMode_r1_waitVerify_time_event_0_raised;
...
/*! Raises the in event 'assignIdDone' that is defined in the default interface scope. */ 
extern void secure_learnIface_raise_assignIdDone(Secure_learn* handle);
...
extern void secure_learnIface_raise_commandsSupportedRequest(Secure_learn* handle, sc_string value);
