...
uint8_t raw_ack_frame_LR[] = { 0x0, 0x0, 0x0, 0x0, 0x00, 0x00, 0x00, 0x0A, 0x00, 0x01 };
...
uint8_t raw_smartstart_frame_LR[] = {0xDB, 0x04, 0xED, 0x2A, 0x00, 0x0F, 0xFF, 0x24, 0x01,
                                     ...
                                     0x5A, 0x87, 0x73, 0x98, 0x9F, 0x6C, 0x7A, 0x35, 0x49};// singlecast
...
const uint16_t dest_id_broadcast = 0xFFF;
...
static void initCommonVariable(void) {
...
void test_ZW_ismyframe_LR(void)
{
  test_vector_t test_vectors[] = {
    ...
    {false ,{0xC9, 0x0C, 0x6C, 0x72}, source_id,       dest_id_broadcast, HDRTYP_TRANSFERACK,    raw_ack_frame_LR}         //17 - FRAME ACK - broadcast (not valid!)
  };
  bool result;
  mock_calls_clear();
